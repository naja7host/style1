		...
		return this.each(function(i, e) {
			...
			var _process = function(e, feed, options) {
				...
				if (feed.description != 'Yahoo! Weather Error') {
					...
					// Add item data
					html += '<div class="weatherCity">بغداد - العراق</div>';
					if (options.country) html += '<div class="weatherCountry">'+ feed.location.country +'</div>';
					html += '<div class="weatherTemp">درجة الحرارة : '+ feed.item.condition.temp +'&deg;</div>';
					// html += '<div class="weatherDesc">'+ feed.item.condition.text +'</div>';
				
					// Add optional data
					if (options.highlow) html += '<div class="weatherRange">القصوى: '+ wf.high +'&deg; الأدنى: '+ wf.low +'&deg;</div>';
					if (options.wind) html += '<div class="weatherWind">الرياح: '+ wd +' '+ feed.wind.speed + feed.units.speed +'</div>';
					if (options.humidity) html += '<div class="weatherHumidity">الرطوبة: '+ feed.atmosphere.humidity +'</div>';
					if (options.visibility) html += '<div class="weatherVisibility">الرؤية: '+ feed.atmosphere.visibility +'</div>';
					if (options.sunrise) html += '<div class="weatherSunrise">الغروب: '+ feed.astronomy.sunrise +'</div>';
					if (options.sunset) html += '<div class="weatherSunset">الشروق: '+ feed.astronomy.sunset +'</div>';
